(function () {
  ...
  const WORKS = [
    ...
    { id: 'w20', cat: 'tvc广告', title: 'TVC广告作品', desc: 'TVC广告 AI 视觉作品描述。', tags: ['TVC广告', '标签', '广告'], img: 'assets/work-dj-detail.png', link: 'https://www.bilibili.com/video/BV1zv4f6qEWC/?share_source=copy_web&vd_source=73a8583309333d473630f5bff63a1b7a' },
    { id: 'w21', cat: 'tvc广告', title: 'TVC广告作品 2', desc: 'TVC广告 AI 视觉作品描述。', tags: ['TVC广告', '标签', '广告'], img: 'assets/work-dj-detail.png', link: 'https://www.bilibili.com/video/BV1zv4f6qEQq/?share_source=copy_web&vd_source=73a8583309333d473630f5bff63a1b7a' },
    { id: 'w22', cat: 'tvc广告', title: 'TVC广告作品 3', desc: 'TVC广告 AI 视觉作品描述。', tags: ['TVC广告', '标签', '广告'], img: 'assets/work-dj-detail.png', link: 'https://www.bilibili.com/video/BV1o64f6PE2i/?share_source=copy_web&vd_source=73a8583309333d473630f5bff63a1b7a' },
  ...
  var filterCarouselTimer = null;
  var filterCarouselPaused = false;

  function startFilterCarousel() {
    stopFilterCarousel();
    filterCarouselTimer = setInterval(function () {
      if (filterCarouselPaused) return;
      filterCarouselIndex = (filterCarouselIndex + 1) % FILTER_CATS.length;
      var cat = FILTER_CATS[filterCarouselIndex].key;
      var buttons = document.querySelectorAll('.filter-btn');
      buttons.forEach(function (b) { b.classList.remove('active'); });
      var activeBtn = document.querySelector('.filter-btn[data-cat="' + cat + '"]');
      if (activeBtn) activeBtn.classList.add('active');
      renderWorks(cat);
    }, 3000);
  }

  function stopFilterCarousel() {
    if (filterCarouselTimer) { clearInterval(filterCarouselTimer); filterCarouselTimer = null; }
  }
  ...
  document.getElementById('filterBar').addEventListener('click', function (e) {
    ...
    renderWorks(cat);
    // Reset carousel index to clicked category
    for (var i = 0; i < FILTER_CATS.length; i++) {
      if (FILTER_CATS[i].key === cat) { filterCarouselIndex = i; break; }
    }
    startFilterCarousel();
  });
